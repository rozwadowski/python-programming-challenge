	...
	def draw(self):
		...
		if self.turn == "One":
			...
			if self.winner == "Draw":
				...
				draw.circle(self.window,(255,0,0),(self.buttons[self.p1].x,self.buttons[self.p1].y),120,3)
			else:
				text = self.Font.render("The winner: "+self.winner,True,(255,255,255))
				draw.circle(self.window,(255,0,255),(self.buttons[self.p1].x,self.buttons[self.p1].y),120,3)
				draw.circle(self.window,(255,255,0),(self.buttons[self.p2].x,self.buttons[self.p2].y),120,3)
